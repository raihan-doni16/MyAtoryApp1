...
import com.example.mystoryapp1.DataDummy
import com.example.mystoryapp1.MainDispatcherRule
...
import com.example.mystoryapp1.getOrAwaitValue
...
class MainViewModelTest{
    @get: Rule
    val instantExexutorRule = InstantTaskExecutorRule()
    ...
    fun `when Get story should Not Null and Return Data `() = runTest {
        ...
        Mockito.`when`(userRepository.getStoryUser()).thenReturn(expectedStory)
        ...
        val differ = AsyncPagingDataDiffer(
            diffCallback = UserAdapter.DIFF_CALBACK,
