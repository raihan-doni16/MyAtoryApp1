...
import com.example.mystoryapp1.createCustomTempFile
import com.example.mystoryapp1.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity() {
    ...
    private  fun takePhoto(){
        ...
        val pgotoFile = createCustomTempFile(application)
        val outputOptions = ImageCapture.OutputFileOptions.Builder(pgotoFile).build()
